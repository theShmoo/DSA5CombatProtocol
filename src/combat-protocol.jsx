...
import IniWidget from "./ini-widget";
import SaveWidget from "./save-widget";
import {calculateStates} from "./state-calculations";
...
class CombatProtocol extends Component {
    ...
    return (
      <Grid fluid>
        ...
        <LocationWidget
          ...
          />
        <a id="downloadAnchorElem" href="#" style={{display: 'none'}}>jsonexport</a>
      </Grid>
    );
  }
}
